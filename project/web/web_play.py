...
project_dir = os.path.dirname(script_dir)   # project/web/ -> project/
repo_root = os.path.dirname(project_dir)    # project/ -> repo root
project_root = repo_root  # alias kept for compatibility with downstream code
modules_dir = os.path.join(repo_root, "modules")
sys.path.insert(0, modules_dir)
sys.path.insert(0, repo_root)
sys.path.insert(0, project_dir)
sys.path.insert(0, os.path.join(project_dir, "src"))
sys.path.insert(0, os.path.join(project_dir, "src", "utils"))
